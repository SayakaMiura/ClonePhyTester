...
Sim2TrueFile={'TGlinear':'TGlinear/True/IDCells_True.meg'}
...
xl = pd.ExcelFile('Example/Tips_for_modification_of_clonephytester/Example_B-user_specified_score/Summary_example_B.xlsx')
